...
from models.stgcn.kinetics import Graph
...
class Model(nn.Module):
    def __init__(self, in_channels=3, seg_len=6, headless=False):
        ...
        self.l7 = TCN_GCN_unit(128, 256, A, stride=2)
        self.l8 = TCN_GCN_unit(256, 256, A)
